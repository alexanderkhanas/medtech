...
const Header = ({
  ...
  const [isCounterAnimation, setCounterAnimation] = useState(false);
  ...
  useEffect(() => {
    if (numberInCart) {
      ...
      setTimeout(() => setCounterAnimation(false), 300);
    }
  }, [numberInCart]);

  console.log(isCounterAnimation);
            ...
            <div className={s.small_menu_item}>
              <div className={s.small_menu_button}>
                ...
                >
                  ...
                  Кошик
                  {!!numberInCart && (
                    <Transition in={isCounterAnimation} timeout={200}>
                      {(state) => {
                        ...
                        return (
                          <div
                            ...
                            className={s.cart__counter_desktop}
                          >
