    ...
    <div>
      ...
      <div className={s.public__offer}>
        ...
        <p>
          ...
          store.fastandclever.com (далі «Веб-сайт», «Веб-сайт Інтернет
          магазину») та опрацювання замовлення Користувача. Це означає, що такі
          дані потрібні, зокрема, для наведеного нижче: - Реєстрації та
          авторизації Користувача на Веб-сайті Інтернет – магазину; -
          Забезпечення створення облікового запису Користувача; - Оформлення та
          розміщення замовлення на товари; - Виконання Продавцем умов договору
          купівлі-продажу товару на відстані; - Оплати товарів, обробки та
          отримання платежів, виставлення рахунків, видачі супровідних
          документів; - Доставки товарів, що замовив Користувач; - Встановлення
          зворотнього зв’язку з Користувачем, включаючи направлення повідомлень,
          запитів, що стосуються використання веб-сайту Інтернет-магазину,
          обробки запитів, замовлень, заявок від Користувача; - Для
        ...
        <p>
          ...
          за адресою: store.fastandclever.com.
        </p>
